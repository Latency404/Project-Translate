...
test('classifyFsError: EPERM → 403 + deutsche Nachricht mit Pfad', () => {
  ...
  assert.match(out.message, /^Zielordner nicht schreibbar: C:\/mods\/DE\/UI\.json/)
})
